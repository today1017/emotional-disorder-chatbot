...
SEED_WORDS = {
    "情绪极性": {
        "积极": ["开心", "高兴", "快乐", "幸福", "美好", "不错", "舒服", "放松",
                 "轻松", "期待", "治愈", "感恩", "喜欢", "顺利", "满足", "温暖",
                 "好转", "恢复", "加油", "坚强", "希望", "有希望", "变好", "好起来",
                 "好多了", "好点", "痊愈", "安稳", "平静", "舒适"],
        "消极": ["痛苦", "难过", "伤心", "难受", "崩溃", "绝望", "无助", "孤独",
                 "疲惫", "焦虑", "压抑", "害怕", "恐惧", "烦躁", "委屈", "沮丧",
                 "心累", "低落", "想哭", "折磨", "煎熬", "好累", "累死",
                 "痛苦迷茫", "活着没意思", "自杀倾向", "情绪低落",
                 # === 访谈新增消极表达 ===
                 "喘不过气", "窒息感", "心慌", "手抖", "喘不上气", "整个人瘫了一样",
                 "心里堵得慌", "空空的", "失落感", "控制不住地想", "脑子停不下来",
                 "自我攻击", "我好没用", "我就是废物", "我恨我自己", "扫把星",
                 "一切都不会好起来", "永远都走不出来", "我的人生完了", "什么都毁了",
                 "装正常人装快乐真累", "白天晚上两个人", "双重消耗", "精疲力尽",
                 "被辜负", "真心不被珍惜", "付出得不到回应", "没人理解我",
                 "被整个世界抛弃", "只有我在黑暗里", "想要一个拥抱",
                 "哭了整整一晚上", "眼睛睁不开", "缩在角落里发抖"],
        "中性": [],
    },
    "求助信号": {
        "是": ["怎么办", "帮帮我", "帮帮我吧", "帮帮忙", "帮助我", "救救", "救救我",
               "谁能", "有人吗", "有没有办法", "不知道怎么办", "怎么办才好", "求助",
               "请教", "咨询", "需要帮助", "帮我", "求求", "带我", "怎么办啊",
               "我需要", "我想找人", "我想问问", "我想聊聊", "我想找 someone",
               # === 访谈新增求助表达 ===
               "我想找人倾诉", "能不能听我说", "有没有人听", "陪陪我", "抱抱我",
               "哪怕只是一句在吗", "会有人看到这条吗", "还有人记得我吗",
               "谁能告诉我该怎么走下去", "哪里才是我的容身之处",
               "如果每天都能有人陪我说句话就好了", "真希望一觉醒来一切都好了",
               "多么希望有人能看穿我的坚强", "拼了命才打出这些字",
               "缩在角落里发抖", "两天没吃饭", "用尽全力"],
        "否": ["没关系", "无所谓", "随便", "随它", "无关紧要", "不太在意"],
    },
    "安全风险": {
        "是": ["自杀", "自残", "想死", "割腕", "跳楼", "跳下去", "吞药", "结束生命",
               "活不下去", "不想活", "不想活了", "伤害自己", "离开世界", "安乐死",
               "轻生", "寻死", "死掉", "死了算了", "一了百了", "离开人世",
               "结束一切", "结束自己", "结束这段生命", "活着没意思", "活着没有意义",
               "没有活下去的勇气", "撑不下去了", "撑不住", "不想撑", "解脱",
               "了结", "别活了", "死了", "不想存在", "自杀意念", "自伤",
               # === 访谈新增高价值风险词 ===
               "划手", "撞墙", "撕指甲", "捶墙", "捶墙流血", "头撞墙", "拳头流血",
               "攒药", "攒够药", "吃药自杀", "准备好跳", "站在天台", "坐在窗边",
               "手里拿着药瓶", "刀片很凉", "看着血流出来", "皮肤上又多了一道",
