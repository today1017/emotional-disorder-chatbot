...
def build_multi_turn_prompt(user_text, rule_result, conversation_history=None,
    ...
    rules += "1. 禁止用以下开头：“听到你说”“看到你这么说”“听你这么说”“看着你说”“感觉到你”，每次回复开头必须不一样；" + chr(10)
    rules += "2. 不要说好听的废话：“一起慢慢来”“别急”“一切都会好的”“给自己一点时间”，这些太像心理咨询师说法；" + chr(10)
    rules += "3. 用具体的、生活化的语言，像朋友发微信一样，例如“那你现在怎么办”“要不你先……”“我上次也……”；" + chr(10)
    rules += "4. 控制在 40-80 字，不要长篇大论；" + chr(10)
